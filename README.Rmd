...
Herramientas para descargar, procesar y analizar los microdatos de la Encuesta Nacional de Ocupación y Empleo (ENOE) del INEGI, México.

Este paquete permite automatizar la descarga, lectura, etiquetado y fusión de los componentes de la ENOE desde 2005 hasta 2024, en distintos formatos de salida (CSV, Parquet, DTA, RDS).
...
Este paquete fue desarrollado para facilitar el trabajo con los microdatos de la ENOE en proyectos académicos y de investigación social.

Proyecto **PAPIIT IN305925 Retos de la Inserción laboral en México**


**Nota:** Este paquete no está afiliado al INEGI. Los datos son propiedad pública y pueden ser consultados en [https://www.inegi.org.mx](https://www.inegi.org.mx).
